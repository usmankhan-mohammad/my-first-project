...
class Room_ec22635 extends Room
{
    ...
    public Direction visit(Visitor visitor, Direction directionVisitorArrivesFrom)
    {
        ...
        visitor.tell("Welcome to Room_ec22635. The lights are " + (lightsOn ? "on" : "off") + ". The trunk is " + (trunkEmpty ? "empty" : "not empty") + ". The poltergeist is " + (poltergeistFriendly ? "friendly" : "grumpy") + ".");
