...
class House_jpp317487 extends House {
    Room[][] rooms = new Room[3][3];
    public House_jpp317487() {
        rooms[0][0] = new Room_ec22960();
        rooms[0][1] = new Room_ec221099();
        rooms[0][2] = new Room_ec22914();
        rooms[1][0] = new Room_ec22960();
        rooms[1][1] = new Room_ec221099();
        rooms[1][2] = new Room_ec22914();
        rooms[2][0] = new Room_ec22960();
        rooms[2][1] = new Room_ec221099();
        rooms[2][2] = new Room_ec22914();
    }
