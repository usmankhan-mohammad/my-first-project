...
class Room_ec22451 extends Room {
    int gold = 5;
    char [] walletcolours = {'r','b','g','n'};
    char [] poorman = {'0','1','2','3','4'};
    Item Red_Wallet= new Item("Red Wallet");
    Item Blue_Wallet = new Item("Blue Wallet");
    Item Green_Wallet = new Item("Green Wallet");
